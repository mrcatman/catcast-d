...
<table class="email__table">
    ...
    <tr>
        <td class="email__header">
            {{ LocalizationHelper::translate("connections.email.restore_header") }}
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="email__text">
            {{ LocalizationHelper::translate("connections.email.restore_text") }}
        </td>
    </tr>
    <tr>
        <td class="email__link-container">
            <a target="_blank" class="email__link"
               href="{{$link}}">  {{ LocalizationHelper::translate("connections.email.restore_button") }}</a>
        </td>
    </tr>
    <tr>
