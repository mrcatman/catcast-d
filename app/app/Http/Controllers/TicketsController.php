...
class TicketsController extends Controller{
    ...
    public function store() {
        ...
        return [
            ...
            'ticket' => $ticket->toResource(),
            'data' => $message->toResource()
        ];
    }
    ...
    public function index() {
        ...
        if (!$is_admin) {
            return $tickets->toResourceCollection();
        }
        // The admin listing replaces every ticket with a hand-built array, so it
        // cannot go through TicketResource: the guesser rejects a collection of
        // non-objects.
        // TODO: this response is assembled by hand - give it a resource of its own
