...
class RadioPlaylistsController extends Controller
{
    ...
    public function getForChannel($channel_id) {
        ...
        return $playlists->toResourceCollection();
    }
    ...
    public function autocomplete($id) {
        ...
        // values() because filter() keeps the original keys, and the resource
        // guesser reads item 0 to work out which resource to use.
        return $tracks->values()->toResourceCollection();
    }
