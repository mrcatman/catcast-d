...
export default {
  ...
  methods: {
    ...
    getBanDurationOptions(form) {
      const options = [
        {name: this.$t('dashboard.banlist.options.1_day'), value: 86400},
        {name: this.$t('dashboard.banlist.options.1_week'), value: 7 * 86400},
        {name: this.$t('dashboard.banlist.options.1_month'), value: 30 * 86400},
        {name: this.$t('dashboard.banlist.options.forever'), value: null},
      ]
      if (form.banned_till !== -1) {
        options.push({name: this.$t('dashboard.banlist.options.select_manually'), value: -1});
      } else {
        options.push({
