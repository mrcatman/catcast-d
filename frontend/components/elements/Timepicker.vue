<template>
<inputBase v-click-outside="hideDropdowns" class="input-base" :autoSize="autoSize" :single="single" :inputValue="val" type="text" :title="title" :placeholder="placeholder" :errors="errors" :prepend="prepend" :description="description">
