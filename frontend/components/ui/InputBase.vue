...
<div class="input__container" :class="containerClasses">
  ...
  <div class="input__loading-overlay" v-if="loading">
	...
	<div v-if="description && description.length" class="input__description">{{description}}</div>
...
const containerClasses = computed(() => {
  return {
    'input__container--with-errors': props.errors && props.errors.length > 0,
    'input__container--disabled': props.disabled,
    'input__container-not-empty': (props.val !== '' || (props.append && props.append !== '') || (props.prepend && props.prepend !== '')),
    'input__element-container--with-prepend': props.prepend,
    'input__element-container--with-append': props.append
  }
})
</script>
<style lang="scss">
