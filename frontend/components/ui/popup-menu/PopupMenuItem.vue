<template>
  <component :is="component" :to="to" @click="onClick" class="popup-menu__item" :class="{'popup-menu__item--selected': selected, 'popup-menu__item--with-delimiter': withDelimiter}">
